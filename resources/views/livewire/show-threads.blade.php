<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
    <div class="w-64">
        <a href="{{route('threads.create')}}"
           class="block w-full py-4 mb-10 bg-gradient-to-r from-blue-600 to-blue-700
           hover:to-blue-600 text-white/90 font-bold text-sm text-center rounded-md"
        >Preguntar</a>
        <ul>
            ...
            <li class="mb-2">
                <a
                    ...
                    hover:text-white font-semi-bold text-xs capitalize"
                >
                    <span
                    ...
                    <div class="w-full">
                        <h2 class="mb-4 flex items-start justify-between">
                            <a
                                ...
                                class="text-xl font-semibold text-white/90"
                            >
                                {{ $thread->title }}
                            </a>
                            <span
                        ...
                        <p class="flex items-center justify-between w-full text-xs">
                            <span class="text-blue-600 font-semibold">
                                {{ $thread->user->name }} <span class="text-white/90"> {{$thread->created_at->diffForHumans()}}</span>
                            </span>
